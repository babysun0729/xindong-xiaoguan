...
if USE_POSTGRES:
    ...
    import sqlite3
    DB_PATH = os.path.join('/tmp', 'xindong.db') if os.environ.get('VERCEL') else os.path.join(os.path.dirname(os.path.dirname(__file__)), 'xindong.db')
